...
API для рекомендаций фильмов для проекта онлайн кинотеатра на основе предпочтений пользователей и истории просмотров с использованием моделей машинного обучения (ALS и LightFM).
