Ниже я составлю полное описание проекта и взаимодействия всех сервисов на основе текущей архитектуры, включая файлы `docker-compose.yml`, `main.py`, `recommend.py`, `recommendation_model.py`, `evaluate_metrics.py`, и `generate_mongo_data.py`. Описание будет включать назначение проекта, архитектуру, взаимодействие компонентов, а также примеры использования.
